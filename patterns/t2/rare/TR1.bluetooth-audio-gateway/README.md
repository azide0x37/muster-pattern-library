...
Do not pretend Bluetooth connected, routed, and playable are the same state.
...
Failures include device absent, connected without sink, routed without playback, and state stale.
