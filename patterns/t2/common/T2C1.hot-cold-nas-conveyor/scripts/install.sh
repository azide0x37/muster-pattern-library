...
usage() {
  printf '%s\n' "Install T2C1.hot-cold-nas-conveyor artifacts for Debian/RPi OS."
...
run install -m 0755 "$pattern_dir/scripts/wait-for-hot-capacity.sh" "$lib_dir/wait-for-hot-capacity.sh"
printf '%s\n' "install plan complete for T2C1.hot-cold-nas-conveyor"
