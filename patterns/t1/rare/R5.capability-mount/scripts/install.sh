...
run install -m 0644 "$pattern_dir/units/muster-capability@.service" "$unit_dir/muster-capability@.service"
run install -m 0755 "$pattern_dir/scripts/check-capability.sh" "$lib_dir/check-capability.sh"
