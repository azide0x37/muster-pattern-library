...
- `units/example.service` is a reviewed protected-job artifact.
...
No known blocker for the stable contract. Future variants can add service-specific recovery actions without changing the bounded failure ratchet.
