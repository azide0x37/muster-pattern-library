...
PATTERNS = [
    ...
    PatternSpec(
        ...
        composes_with=["TC3.scheduled-herald"],
    ...
    PatternSpec(
        ...
        ["C1.service-capsule", "C2.persistent-tick", "C5.failure-ratchet"],
        ["C1.service-capsule", "C2.persistent-tick", "C5.failure-ratchet"],
        ["TR1.bluetooth-audio-gateway", "T3C1.edge-appliance-bundle"],
    ),
    PatternSpec(
        ...
        ["C1.service-capsule", "C2.persistent-tick", "C5.failure-ratchet"],
        ["C1.service-capsule", "C2.persistent-tick", "C5.failure-ratchet"],
        ["TR1.bluetooth-audio-gateway", "TR3.edge-control-plane"],
    ),
    PatternSpec(
        ...
        ["TC4.self-healing-reconnector", "TC5.local-sidecar-bridge", "R2.device-binding", "R4.state-ledger"],
        ["TC4.self-healing-reconnector", "TC5.local-sidecar-bridge", "R2.device-binding", "R4.state-ledger"],
    ...
    PatternSpec(
        ...
        ["TC1.hot-cold-nas-conveyor", "R1.socket-anteroom", "R3.cgroup-governor", "R5.capability-mount"],
        ["TC1.hot-cold-nas-conveyor", "R1.socket-anteroom", "R3.cgroup-governor", "R5.capability-mount"],
        ["T3R1.multi-resource-orchestrator"],
    ),
    PatternSpec(
        ...
        ["edge_control_plane"],
        ["TC2.dropfolder-spooler", "TC3.scheduled-herald", "TC5.local-sidecar-bridge", "R1.socket-anteroom", "R2.device-binding", "R4.state-ledger"],
        ["TC2.dropfolder-spooler", "TC3.scheduled-herald", "TC5.local-sidecar-bridge", "R1.socket-anteroom", "R2.device-binding", "R4.state-ledger"],
        ["T3R1.multi-resource-orchestrator"],
    ),
    PatternSpec(
        ...
        ["TC1.hot-cold-nas-conveyor", "TC3.scheduled-herald", "TC4.self-healing-reconnector", "TC5.local-sidecar-bridge"],
        ["TC1.hot-cold-nas-conveyor", "TC3.scheduled-herald", "TC4.self-healing-reconnector", "TC5.local-sidecar-bridge"],
    ...
    PatternSpec(
        ...
        ["T3C1.edge-appliance-bundle", "TR1.bluetooth-audio-gateway", "TR2.lazy-capability-media-bus", "TR3.edge-control-plane", "R2.device-binding", "R4.state-ledger"],
        ["T3C1.edge-appliance-bundle", "TR1.bluetooth-audio-gateway", "TR2.lazy-capability-media-bus", "TR3.edge-control-plane", "R2.device-binding", "R4.state-ledger"],
        ["T3M1.machine-priest"],
    ...
    PatternSpec(
        ...
        ["staged_recovery"],
        ["C5.failure-ratchet", "TC4.self-healing-reconnector", "R4.state-ledger", "M2.holonomy-detector", "M5.temporal-sheaf"],
        ["C5.failure-ratchet", "TC4.self-healing-reconnector", "R4.state-ledger", "M2.holonomy-detector", "M5.temporal-sheaf"],
        [],
    ...
    PatternSpec(
        ...
        ["global_state_gluing"],
        ["M1.local-truth-sheaf", "M3.simplicial-task-graph", "TR3.edge-control-plane", "TC3.scheduled-herald"],
        ["M1.local-truth-sheaf", "M3.simplicial-task-graph", "TR3.edge-control-plane", "TC3.scheduled-herald"],
        [],
    ),
    PatternSpec(
        ...
        ["watchdog_drift_loop"],
        ["M2.holonomy-detector", "TC3.scheduled-herald", "TC4.self-healing-reconnector", "R4.state-ledger"],
        ["M2.holonomy-detector", "TC3.scheduled-herald", "TC4.self-healing-reconnector", "R4.state-ledger"],
        [],
    ),
    PatternSpec(
        ...
        ["M4.local-topos-runtime", "M5.temporal-sheaf", "TR3.edge-control-plane", "R5.capability-mount"],
        ["M4.local-topos-runtime", "M5.temporal-sheaf", "TR3.edge-control-plane", "R5.capability-mount"],
        [],
...
EXAMPLES = {
    "edge-appliance-bundle": {
        ...
        "patterns": ["T3C1.edge-appliance-bundle", "TC1.hot-cold-nas-conveyor", "TC3.scheduled-herald", "TC4.self-healing-reconnector", "TC5.local-sidecar-bridge"],
    ...
    "bluetooth-audio-gateway": {
        ...
        "patterns": ["TR1.bluetooth-audio-gateway", "T3R1.multi-resource-orchestrator", "R2.device-binding", "R4.state-ledger"],
    ...
    "dvd-ripper-pi": {
        "title": "DVD Ripper Pi",
        "patterns": ["C1.service-capsule", "C2.persistent-tick", "C3.dropfolder-trigger", "C4.lazy-resource-gate", "C5.failure-ratchet", "TC1.hot-cold-nas-conveyor", "TC2.dropfolder-spooler", "TC3.scheduled-herald", "T3C1.edge-appliance-bundle"],
    ...
    "gcode-spooler": {
        ...
        "patterns": ["TC2.dropfolder-spooler", "TR3.edge-control-plane", "R2.device-binding"],
